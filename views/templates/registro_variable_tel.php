...
<form method="post">
				<table class="table bg-info"  id="tabla">
					<tr class="fila-fija">
						<td><input type="text" required name="tel[]" placeholder="Teléfono"/></td>
...
while(true) {
	...
	$tel=(( $item1 !== false) ? $item1 : ", &nbsp;");     
	
//print_r($retorno);
	
	$array_insert = array(
		'telefono' => $tel,
		'id_rel_telefono' => $retorno->id_persona

	);


	$this->db->insert('telefonos', $array_insert);
